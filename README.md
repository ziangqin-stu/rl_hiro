...
​				select next goal via goal transition model with explore-noise  ![](http://latex.codecogs.com/gif.latex?\\g_{t+1} \sim h(s_{t}, g_{t}, s_{t+1}) + \epsilon, \epsilon \sim N(0, \sigma))
